...
Currenty, I am a Research Intern at Meta, I work with the AI4AR team on video and 3D object generation.
<!-- I also work as an AI Advisor to [Blue Lion Labs](https://bluelionlabs.com/){:target="_blank"}. -->
Previously, I was a MITACS Research Intern at [Unity Labs](https://unity.com/labs), I worked on 3D human pose estimation and inverse kinematics from video. In Fall 2019, I was a Research Intern at [Google](https://ai.google/research/teams/perception/){:target="_blank"}, Mountain View in the [Google AI Perception](https://ai.google/research/teams/perception/){:target="_blank"} team.
